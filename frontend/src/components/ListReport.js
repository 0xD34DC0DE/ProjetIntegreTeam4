    ...
    <>
      {visible && (
        <Box>
          ...
          <FormControl
            sx={{ display: "inline-block", width: "150px", padding: "10px" }}
          >
            <InputLabel
              id="sessionSelectInputLabel"
              sx={{ fontsize: "large", padding: "10px" }}
            >
              Session
            </InputLabel>
            <Select
            ...
            >
              ...
              <MenuItem key={119} value={119}>
                Hiver 2019
              </MenuItem>
              <MenuItem key={219} value={219}>
                Été 2019
              </MenuItem>
              <MenuItem key={319} value={319}>
                Automne 2019
              </MenuItem>
              <MenuItem key={120} value={120}>
                Hiver 2020
              </MenuItem>
              <MenuItem key={220} value={220}>
                Été 2020
              </MenuItem>
              <MenuItem key={320} value={320}>
                Automne 2020
              </MenuItem>
              <MenuItem key={121} value={121}>
                Hiver 2021
              </MenuItem>
              <MenuItem key={221} value={221}>
                Été 2021
              </MenuItem>
              <MenuItem key={321} value={321}>
                Automne 2021
              </MenuItem>
              <MenuItem key={122} value={122}>
                Hiver 2022
              </MenuItem>
              <MenuItem key={222} value={222}>
                Été 2022
              </MenuItem>
              <MenuItem key={322} value={322}>
                Automne 2022
              </MenuItem>
            </Select>
          </FormControl>
